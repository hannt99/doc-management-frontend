...
const Header = ({ setToggle /*socket*/ }) => {
    ...
    return (
        <>
            <div
                id="here1"
                className="flex items-center justify-between xl:justify-end w-full h-[64px] bg-white text-[#9fa9ae] pl-[16px] pr-[24px] border-b-[1px] border-solid border-[#cccccc]"
            >
                <div
                ...
                <div id="_here2" className="flex items-center">
                    <div id="_here3" className="flex group relative p-[8px] hover:text-black cursor-pointer">
                        <FontAwesomeIcon className="text-[2.2rem] leading-none m-auto" icon={faBell} />
                        <p
                            className={
                                notificationNotReadLength(notifications) > 0
                                    ? 'absolute block top-0 right-0 min-w-[18px] rounded-full p-1.5 leading-none text-[1rem] font-semibold text-[white] text-center bg-red-600'
                                    : 'hidden'
                            }
                        >
                        ...
                        <div
                            id="_here4"
                            className="hidden group-hover:block absolute top-[48px] right-[-80px] md:right-0 bg-white text-black shadow-4Way z-50"
                        >
                            <div className="p-[12px] cursor-default">
                                ...
                                <div className="flex items-center gap-x-3 text-[1.5rem]">
                                    <div
                                        ...
                                        className={
                                            tab === false
                                                ? 'rounded-xl p-3 bg-blue-50 hover:bg-[#f1f1f1] text-blue-600 font-semibold cursor-pointer'
                                                : 'rounded-xl p-3 hover:bg-[#f1f1f1] font-semibold cursor-pointer'
                                        }
                                    >
                                        Tất cả
                                    </div>
                    ...
                    <div id="_here5" className="relative group">
                        <div className="flex items-center gap-x-3 cursor-pointer">
                            <div className="w-[40px] h-[40px] ml-8 rounded-full">
                                <img
                            ...
                            <h3 className="hidden md:block max-w-[150px] truncate font-bold text-black ">{userName}</h3>
                        ...
                        <div
                            id="_here6"
                            className="hidden group-hover:block absolute top-[50px] right-0 bg-white shadow-4Way text-black"
                        >
                            <ul className="w-[180px]">
                                <li className="p-[12px] cursor-pointer hover:bg-[#eeeeee] hover:text-[#321fdb]">
                                ...
                                <li
                                    ...
                                    className="p-[12px] cursor-pointer hover:bg-[#eeeeee] border-t hover:text-[#321fdb]"
                                >
