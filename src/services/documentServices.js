...
export const getAllDocument = async (
    ...
    try {
        const res = await httpRequest.get(
            `/document/get-all?page=${page}&limit=${limit}&documentIn=${flag}&documentName=${fName}&note=${fNote}&code=${fCode}&type=${fType}&issuedDate=${fIssuedDate}&sender=${fSender}&level=${fLevel}&status=${fStatus}`,
        );
        return res.data;
    } catch (error) {
        console.log(error);
...
// Change department of document function
